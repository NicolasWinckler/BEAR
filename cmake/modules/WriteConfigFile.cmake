...
#    SET(VMCWORKDIR ${CMAKE_SOURCE_DIR})  
  ...
  IF(CMAKE_SYSTEM_NAME MATCHES Linux)
    IF(BEARPATH)
      configure_file(${BEARPATH}/share/fairbase/cmake/scripts/check_system.sh.in
                     ${CMAKE_CURRENT_BINARY_DIR}/check_system.sh
                    )
      configure_file(${BEARPATH}/share/fairbase/cmake/scripts/check_system.csh.in
  ...
  ElseIf(CMAKE_SYSTEM_NAME MATCHES Darwin)
    IF(BEARPATH)
      configure_file(${BEARPATH}/share/fairbase/cmake/scripts/check_system_mac.sh.in
                     ${CMAKE_CURRENT_BINARY_DIR}/check_system.sh
                    )
      configure_file(${BEARPATH}/share/fairbase/cmake/scripts/check_system_mac.csh.in
                     ${CMAKE_CURRENT_BINARY_DIR}/check_system.csh
                    )
    ELSE(BEARPATH)
...
#  Set(VMCWORKDIR ${C})
  ...
  IF(${filename} MATCHES "[.]csh.*$")
    IF(BEARPATH)
    configure_file(${BEARPATH}/share/fairbase/cmake/scripts/config.csh.in
  ...
  ELSE(${filename} MATCHES "[.]csh.*$")
    IF(BEARPATH)
    configure_file(${BEARPATH}/share/fairbase/cmake/scripts/config.sh.in
	           ${CMAKE_CURRENT_BINARY_DIR}/${filename}
                  )
    ELSE(BEARPATH) 
